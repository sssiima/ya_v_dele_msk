...
const CalendarPage = () => {
  ...
  const upcomingEvents: Event[] = [
    {
      ...
      description: 'Тёплая атмосфера, откровенные разговоры и советы от опытных предпринимателей. Настоящая возможность задать любой вопрос и получить поддержку от менторов.',
      location: '',
      time: '',
    },
    {
  ...
  const calendarEvents = [
    { id: 1, title: 'Менторская гостиная', date: '5 ноября' },
    { id: 2, title: 'Открытие', date: '7 ноября' },
    { id: 3, title: 'Форум YouLead', date: '8-9 ноября' },
    { id: 4, title: 'Промежуточный воркшоп', date: '14-16 ноября' },
