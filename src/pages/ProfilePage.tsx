...
const ProfilePage = () => {
  ...
  const scrollContainerRefmk = useRef<HTMLDivElement>(null);
    ...
    const mk_list = [
      ...
      { title: "Третий мастер-класс", subtitle: 'MVP. HADI - циклы.', image: '/images/mkthirdopen.png', pres: 'https://drive.google.com/file/d/1KACuNbGwN4b2DXXe3eXNz9pyIhoRO7Nu/view?usp=drive_link', method: 'https://drive.google.com/file/d/1TwhSS7atv5vVytlbJpkZr5ZQ0p-8QXjK/view?usp=drive_link', disabled: true },
      { title: "Четвертый мастер-класс", subtitle: 'Бизнес - модель. Базовый трек', image: '/images/mkfourthbase.png', pres: 'https://drive.google.com/file/d/15mRrdWcEHA_NtpT0QEaNv_pmSs9UJZAN/view?usp=drive_link', method: 'https://drive.google.com/file/d/18G_39Sqrx9LF39R1lcmusKPl-iH-LlYc/view?usp=drive_link', disabled: true },
      { title: "Пятый мастер-класс", subtitle: 'Финансы. Базовый трек', image: '/images/mkfifthbase.png', pres: 'https://drive.google.com/file/d/1KZEn8Clb9KC1Lh4dR5GRtiI3YrU7CX_6/view?usp=drive_link', method: 'https://drive.google.com/file/d/11bUS0HCCpJCF8BBnOqdHh8bYnXvLKDBE/view?usp=drive_link', disabled: true },
      { title: "Шестой мастер-класс", subtitle: 'Маркетинг. Базовый трек', image: '/images/mksixthbase.png', pres: 'https://drive.google.com/file/d/1-ICPM2FI3bkJuMimfSe2SUr2w8OPrcOE/view?usp=drive_link', method: 'https://drive.google.com/file/d/1z6bero0MFzAoajn_yn8QuayVtvG2FLHz/view?usp=drive_link', disabled: true },
      { title: "Четвертый мастер-класс", subtitle: 'Бизнес - модель. Социальный трек', image: '/images/mkfourthsoc.png', pres: 'https://drive.google.com/file/d/1kjEMVwHUYcX9UvqyAJizJohVFVeX_R0K/view?usp=drive_link', method: 'https://drive.google.com/file/d/1xYaAB6w8U_p_-TSIv8cN0a0zl6Kid7NH/view?usp=drive_link', disabled: true },
      { title: "Пятый мастер-класс", subtitle: 'Финансы. Социальный трек', image: '/images/mkfifthsoc.png', pres: 'https://drive.google.com/file/d/1wJeZcuuyTVpy4pOunOH_5Z92d6eaxSMT/view?usp=drive_link', method: 'https://drive.google.com/file/d/1mcU4RSJkvnfJMDKz9wGOGkdx5-m87_pd/view?usp=drive_link', disabled: true },
      { title: "Шестой мастер-класс", subtitle: 'Маркетинг. Социальный трек', image: '/images/mksixthsoc.png', pres: 'https://drive.google.com/file/d/1-bKB_NEDgbMvLkJpAvRq2b-3XDHTxawY/view?usp=drive_link', method: 'https://drive.google.com/file/d/1xlyLJVaxC_loHbwZOUTzaqxf6oSCeiI8/view?usp=drive_link', disabled: true },
      { title: "Четвертый мастер-класс", subtitle: 'Бизнес - модель. Инновационный трек', image: '/images/mkfourthinn.png', pres: 'https://drive.google.com/file/d/1O4tW61bHzY1YWLAqJ6bzGq09-VGUIKy5/view?usp=drive_link', method: 'https://drive.google.com/file/d/1qvYNoSvrr4RtpPGqImgyNgLWbw1VxGAq/view?usp=drive_link', disabled: true },
      { title: "Пятый мастер-класс", subtitle: 'Финансы. Инновационный трек', image: '/images/mkfifthinn.png', pres: 'https://drive.google.com/file/d/1eEB2WVfku9Wg5x5salXk2Bh7Cc9rUUHv/view?usp=drive_link', method: 'https://drive.google.com/file/d/1MICAFnuaKzXGYfQImAHM-v5plljCqHZJ/view?usp=drive_link', disabled: true },
      { title: "Шестой мастер-класс", subtitle: 'Маркетинг. Инновационный трек', image: '/images/mksixthinn.png', pres: 'https://drive.google.com/file/d/1Q48DKHZL36Rql5eG-7mzT2TfA1bpfuvO/view?usp=drive_link', method: 'https://drive.google.com/file/d/19vrlI9yMKf31pyzoJtFbSZd3RxW5PTNK/view?usp=drive_link', disabled: true },
  ]
                      ...
                      {isProfileExpanded && !isEditing && (
                        <div className='w-full text-xs'>
                          ...
                          <div className='mb-2'>
                            ...
                            <input value={email} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                          </div>
                          <div className='mb-2'>
                            <p><strong>ВУЗ</strong></p>
                            <input value={university} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                          </div>
                          <div className='flex flex-row gap-2 mb-2'>
                            <div className='flex-1'>
                              <p><strong>Уровень подготовки</strong></p>
                              <input value={educationLevel} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                            </div>
                            <div className='flex-1'>
                              <p><strong>Курс обучения</strong></p>
                              <input value={course} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                            </div>
                          </div>
                          <div className='flex flex-row gap-2 mb-2'>
                            <div className='flex-1'>
                              <p><strong>Факультет</strong></p>
                              <input value={faculty} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                            </div>
                            <div className='flex-1'>
                              <p><strong>Форма обучения</strong></p>
                              <input value={educationForm} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                            </div>
                          </div>
                          <div className='mb-2'>
                            <p><strong>Номер телефона</strong></p>
                            <input value={phone} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                          </div>
                          <div className='mb-2'>
                            <p><strong>Ссылка на ВКонтакте</strong></p>
                            <input value={vkLink} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                          </div>
                          <div className='flex flex-row gap-2 mb-2'>
                            <div className='flex-1'>
                              <p><strong>Дата рождения</strong></p>
                              <input value={birthDate} type='date' disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                            </div>
                            <div className='flex-1'>
                              <p><strong>Пол</strong></p>
                              <input value={gender} disabled className="w-full px-4 py-3 border border-brand rounded-full h-[30px] flex items-center italic text-xs mt-1"/>
                            </div>
                          </div>
