...
const ProfilePage = () => {
  ...
  const scrollContainerRefmk = useRef<HTMLDivElement>(null);
    ...
    const mk_list = [
      ...
      { title: "Третий мастер-класс", subtitle: 'MVP. HADI - циклы.', image: '/images/mkthird.png', pres: 'https://drive.google.com/file/d/1KACuNbGwN4b2DXXe3eXNz9pyIhoRO7Nu/view?usp=drive_link', method: 'https://drive.google.com/file/d/1TwhSS7atv5vVytlbJpkZr5ZQ0p-8QXjK/view?usp=drive_link', disabled: true },
      { title: "Четвертый мастер-класс", subtitle: 'Бизнес - модель. Базовый трек', image: '/images/mkfourth.png', pres: 'https://drive.google.com/file/d/15mRrdWcEHA_NtpT0QEaNv_pmSs9UJZAN/view?usp=drive_link', method: 'https://drive.google.com/file/d/18G_39Sqrx9LF39R1lcmusKPl-iH-LlYc/view?usp=drive_link', disabled: true },
      { title: "Пятый мастер-класс", subtitle: 'Финансы. Базовый трек', image: '/images/mkfifth.png', pres: 'https://drive.google.com/file/d/1KZEn8Clb9KC1Lh4dR5GRtiI3YrU7CX_6/view?usp=drive_link', method: 'https://drive.google.com/file/d/11bUS0HCCpJCF8BBnOqdHh8bYnXvLKDBE/view?usp=drive_link', disabled: true },
      { title: "Шестой мастер-класс", subtitle: 'Маркетинг. Базовый трек', image: '/images/mksixth.png', pres: 'https://drive.google.com/file/d/1-ICPM2FI3bkJuMimfSe2SUr2w8OPrcOE/view?usp=drive_link', method: 'https://drive.google.com/file/d/1z6bero0MFzAoajn_yn8QuayVtvG2FLHz/view?usp=drive_link', disabled: true },
      { title: "Четвертый мастер-класс", subtitle: 'Бизнес - модель. Социальный трек', image: '/images/mkfourth.png', pres: 'https://drive.google.com/file/d/1kjEMVwHUYcX9UvqyAJizJohVFVeX_R0K/view?usp=drive_link', method: 'https://drive.google.com/file/d/1xYaAB6w8U_p_-TSIv8cN0a0zl6Kid7NH/view?usp=drive_link', disabled: true },
      { title: "Пятый мастер-класс", subtitle: 'Финансы. Социальный трек', image: '/images/mkfifth.png', pres: 'https://drive.google.com/file/d/1wJeZcuuyTVpy4pOunOH_5Z92d6eaxSMT/view?usp=drive_link', method: 'https://drive.google.com/file/d/1mcU4RSJkvnfJMDKz9wGOGkdx5-m87_pd/view?usp=drive_link', disabled: true },
      { title: "Шестой мастер-класс", subtitle: 'Маркетинг. Социальный трек', image: '/images/mksixth.png', pres: 'https://drive.google.com/file/d/1-bKB_NEDgbMvLkJpAvRq2b-3XDHTxawY/view?usp=drive_link', method: 'https://drive.google.com/file/d/1xlyLJVaxC_loHbwZOUTzaqxf6oSCeiI8/view?usp=drive_link', disabled: true },
      { title: "Четвертый мастер-класс", subtitle: 'Бизнес - модель. Инновационный трек', image: '/images/mkfourth.png', pres: 'https://drive.google.com/file/d/1O4tW61bHzY1YWLAqJ6bzGq09-VGUIKy5/view?usp=drive_link', method: 'https://drive.google.com/file/d/1qvYNoSvrr4RtpPGqImgyNgLWbw1VxGAq/view?usp=drive_link', disabled: true },
      { title: "Пятый мастер-класс", subtitle: 'Финансы. Инновационный трек', image: '/images/mkfifth.png', pres: 'https://drive.google.com/file/d/1eEB2WVfku9Wg5x5salXk2Bh7Cc9rUUHv/view?usp=drive_link', method: 'https://drive.google.com/file/d/1MICAFnuaKzXGYfQImAHM-v5plljCqHZJ/view?usp=drive_link', disabled: true },
      { title: "Шестой мастер-класс", subtitle: 'Маркетинг. Инновационный трек', image: '/images/mksixth.png', pres: 'https://drive.google.com/file/d/1Q48DKHZL36Rql5eG-7mzT2TfA1bpfuvO/view?usp=drive_link', method: 'https://drive.google.com/file/d/19vrlI9yMKf31pyzoJtFbSZd3RxW5PTNK/view?usp=drive_link', disabled: true },
  ]
